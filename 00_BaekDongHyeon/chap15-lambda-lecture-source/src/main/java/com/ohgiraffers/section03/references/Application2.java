...
public class Application2 {
  public static void main(String[] args) {
    ...
    Function<Integer, Integer> lambda
        = (num) -> Calculator.double1(num);

    System.out.println("람다식 방식: " + lambda.apply(5));

    // 메서드 참조 방식
    Function<Integer, Integer> methodRef
        = Calculator::double1;
    ...
    // 람다식 방식
    BiFunction<Integer, Integer, Integer> sumLambda
        = (a, b) -> Calculator.sum(a, b);
    System.out.println("람다식: 10 + 20 = " + sumLambda.apply(10, 20));

    // 메서드 참조 방식
    BiFunction<Integer, Integer, Integer> sumMethodRef
        = Calculator::sum;
