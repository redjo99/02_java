package com.qew032.section02.variable;
...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    /* 개발자들의 약속(규약) */
    // 2-1. 변수명의 길이 제한은 없다.
    int skjdflkajgioejwflakjsflkjsoifjeoljfsgseajfhkahsefk = 10;
    System.out.println("skjdflkajgioejwflakjsflkjsoifjeoljfsgseajfhkahsefk = " + skjdflkajgioejwflakjsflkjsoifjeoljfsgseajfhkahsefk);

    // 2-2. 여러 단어의 합성어는 camel-case 형식으로 작성한다.
    // camel-case(낙타 표기법)
    // 모든 단어를 붙여 쓰되, 연결되는 단어의 첫 글자를 대문자로
    int maxAge = 40;
    int showMeTheMoney = 10000;
    String myNameIsYoonSungWon = "윤성원";
    ...
    // 2-4. 한글로 변수명을 설정할 수 있지만 권장하지 않는다.
    ...
    String goHome;    // 동사 권장 x, 동사는  method이름으로 권장
    String home;
