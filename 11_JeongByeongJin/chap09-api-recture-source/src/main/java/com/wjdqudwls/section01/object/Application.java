...
public class Application {
  public static void main(String[] args) {
    ...
    /* print 구문, 문자열 이어쓰기 등에 참조형 변수가 사용되면 컴파일러가 자동으로 .toString()을 추가해준다. */
    System.out.println("b1.toSting() : " + b1.toString());
    ...
    // b3, b4 동일비교 (==, 참조하고 있는 주소가 같은지 비교)
    System.out.println("동일한가? " + (b3 == b4));
    // b3, b4 동일비교 (equals(), 객체가 가지고 있는 필드 값이 모두 같은지 비교)
