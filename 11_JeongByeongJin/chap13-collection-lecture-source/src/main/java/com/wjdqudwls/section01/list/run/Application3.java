...
import com.wjdqudwls.section01.Service.BookService;
import com.wjdqudwls.section01.list.dto.BookDTO;
...
public class Application3 {
  ...
  public void run() {
    ...
    do {
      ...
      System.out.println("2. 도서 상세 조회(도서번호)");
  ...
  * */
  ...
  private void addBook(){
    ...
    // DTO(Data transfer Object) : 계층간 뎅터 전달 목적의 객체
  ...
  private void updateBook(){
    ...
    // -> 없으면 메서드 종료
    System.out.print("수정할 조회할 도서 번호 입력 : ");
    int bookNumber = sc.nextInt();
    ...
    System.out.print("수정할 첵 제목 : ");
    String updateTitle = sc.nextLine();

    System.out.print("수정할 첵 저자 : ");
    String updateAuthor = sc.nextLine();

    System.out.print("수정할 첵 가격 : ");
