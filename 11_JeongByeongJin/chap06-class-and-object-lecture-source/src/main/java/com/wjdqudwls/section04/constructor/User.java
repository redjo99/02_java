package com.wjdqudwls.section04.constructor;
...
public class User {
  ...
  /* 기본 생성자
   * - 매개 변수가 없는 생성자
   * - 클래스 내에 생성자가 1개도 없다면 (== 0)
   *   컴파일러에 의해서 자동으로 추가된다.
   * */

  public User() {
    System.out.println("Uesr 기본 생성자 호출됨");
  }

  /* 2. 매개변수 있는 생성자
   * 초기화할 필드가 여러 개 있을 경우사용 */
  ...
  public void method1(String a, int b, char c){}
}
