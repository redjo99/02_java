package com.wjdqudwls.section06.finalkeyword;
...
*/
   ...
   * NON_STATIC_NUM 이 같이 할당됨 */

  // 인스턴스가 생성될 때 값이 대입되지 않은 final 필드에 자동으로 0이 초기화 되는 문제가 발생
  // -> 원하는 값 대입 불가능
  ...
  public FinalTest(){
    NON_STATIC_NUM2 = 100; // 생성자가 JVM 기본값 대입보다 우선순위가 높다
