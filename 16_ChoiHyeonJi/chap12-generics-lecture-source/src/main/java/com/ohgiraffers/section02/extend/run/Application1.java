...
public class Application1 {
  public static void main(String[] args) {
    ...
    // RabbitFarm<Animal> farm1 = new RabbitFarm<Animal>();RabbitFarm<Animal> farm1 = new RabbitFarm<Animal>(); //public class RabbitFarm <T extends Rabbit> 여기 extends Rabbit 지우면 오류 지워짐
