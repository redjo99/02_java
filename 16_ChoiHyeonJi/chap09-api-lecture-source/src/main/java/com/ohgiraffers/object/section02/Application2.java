package com.ohgiraffers.object.section02;
...
public class Application2 {
  public static void main(String[] args) {
    ...
    * */
    ...
    String str1 = "java";
    String str2 = "java";
    String str3 = new String("java"); // 힙 영역에 저장하고 있음.
    String str4 = new String("java");


    //str1 주소 == str2 주소 ? true -> 두개 다 같은 곳을 바라보고 있는 것 -> 동일한 값을 가진 문자열 인스턴스를 단일 인스턴스로 관리
     ...
     * */
    System.out.println("str2 == str3" + (str1 == str2)); // false

    /* 동일한 방식으로 인스턴스를 생성하고 값 또한 같더라도
     * 새로운 인스턴스를 생성하는 방식은 서로 다른 주소를 가지고 있기 때문에 false를 반환한다.
     * */
    System.out.println("str3 == str4" + (str1 == str2)); // false 힙 같은 곳을 바라보고 있지 않음
    ...
    System.out.println(System.identityHashCode(str1)); //식별 해시코드 (몰라도됨)
    // 오버라이딩 하기 전 해시코드 보여줌

    /* 문자열은 불변이라는 특징을 가진다.
     * 기존 문자열에 + 연산을 수행하는 경우 문자열을 수정하는 것이 아닌 새로운 문자열을 할당하게 된다.
     * */
    str2 += "oracle"; // -> 참조하는 곳 바꿈
