...
public class Application2 {
  public static void main(String[] args) {
    ...
    System.out.println("sum.sumTwoNumber(10, 20) : " + sum.sumTwoNumber(10, 30));

    /* 람다식 사용 */
    // {} 내부 코드가 한줄 -> 중괄호 생략 가능
    // 단 한 줄인 코드가 return 구문이면 return 생략 가능
    //OuterInterface.Sum sum2 = (int a, int b) -> { return a + b; };
    ...
    System.out.println("sum2.sumTwoNumber(10, 20) : " + sum2.sumTwoNumber(10, 30));
  }
}
