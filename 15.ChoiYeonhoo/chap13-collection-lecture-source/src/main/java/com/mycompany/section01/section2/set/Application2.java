...
public class Application2 {
  public static void main(String[] args) {
    ...
    *
    * LinkedHashSet : hashCode를 이용해서 검색 속도를 증가시킨 Set + 순서 유지
    * - 사용 조건 : Set에 저장되는 인스턴스는 equals(), hashCode() 오버라이딩이 필수
    * */
    ...
    * -> Set 데이터 순회 방법을 이용 (순차 접근) */
    ...
    /* 2. Iterable의 iterator() 메서드(반복자) */

    // set에 저장된 요소를 반복하면서 순회하는 인스턴를 생성 후 반환
