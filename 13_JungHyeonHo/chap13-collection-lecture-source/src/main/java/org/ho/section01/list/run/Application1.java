package org.ho.section01.list.run;
...
public class Application1 {
  public static void main(String[] args) {
    ...
    slist.add("world");
    slist.add("hello");
    //slist.add(0);//타입 체크 오류

    for (String s : slist) {
      // 무조건 String 타입이니까 String 전용 메서드 호출 가능
    ...
    for (Object o : olist) {
      if (o instanceof String) {
        System.out.println(((String) o).length()); // 다운 캐스팅
      } else if (o instanceof Integer) {
        System.out.println(((Integer) o).intValue()); // 다운 캐스팅
      }
    }

    /* 3. ArrayList를 이용한 코드 */

    // 1) boolean add(E e) : e를 리스트 마지막 요소로 추가 후 true반환
    ...
    System.out.println("before = " + fruits.remove(0));
    System.out.println("fruits = " + fruits);
