...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    /* java 개발자들의 약속(규약) */
    // 2-1. 변수명의 길이 제한은 없다.
    int qwewqrkdmfaskgmskalfdskalgmskalfdksadlsakflskldfkdslakf = 10;
    System.out.println("qwewqrkdmfaskgmskalfdskalgmskalfdksadlsakflskldfkdslakf = " + qwewqrkdmfaskgmskalfdskalgmskalfdksadlsakflskldfkdslakf);
    ...
    // -> 다른 단어 또는 DB와 연결 시 모호함 발생시킬 수 있음

    int user_name;  // 애러는 아니지만 쓰지말자!
    int userName;
